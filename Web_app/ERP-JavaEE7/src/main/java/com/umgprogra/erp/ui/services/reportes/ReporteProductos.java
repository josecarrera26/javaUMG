...
public class ReporteProductos implements Serializable {
    ...
    public void generarReporte(ActionEvent pActionEvent) {
        ...
        try {
            ...
            List<Inventario> resultados = null;

            Query query2 = entity.createNamedQuery("Inventario.findAll", Inventario.class);
            ...
            String reportPath = this.getRealPath("reportes/ReporteProducto.jasper");
            ...
            httpServletResponse.addHeader("Content-disposition", "attachment; filename=reporteInventario.pdf");
