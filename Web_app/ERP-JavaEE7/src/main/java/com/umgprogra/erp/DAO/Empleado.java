...
@NamedQueries({
    ...
    @NamedQuery(name = "Empleado.findByEmpleadoPassword", query = "SELECT e.nombreEmpleado, e.password  FROM Empleado WHERE e.nombreEmpleado :nombreEmpleado and e.password = :password")})
