...
@NamedQueries({
    ...
    @NamedQuery(name = "Empleado.findByEmpeadoPassword", query = "SELECT nombreEmpleado, password  FROM Empleado e WHERE e.password = :password and e.nombreEmpleado = = :nombreEmpleado")})
